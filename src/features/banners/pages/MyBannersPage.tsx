...
const MyBannersPage = () => {
  ...
  return (
    <Container maxWidth="md">
      ...
      {status === 'success' && (banners.length > 0) && <BannerTable data={banners} setOpenDialog={setBannerToDelete} page="my-banners"/>}
      ...
      {status === 'success' && banners.length === 0 && <Alert severity="info">You hadn't created banners yet.</Alert>}
      <DeleteBannerDialog
